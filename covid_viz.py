...
plt.bar(dev_x, dev_y, label='Average Covid Deaths per day')
plt.legend()
plt.grid()
plt.show()
...
plt.plot(dev_x, dev_y, label='Number of Covid Cases per Month')
plt.plot(dev_x, dev_y2, label='Number of Covid Deaths per Month')
plt.legend()
plt.grid()
plt.show()
